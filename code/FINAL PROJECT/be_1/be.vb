...
Public Class Form1
    ...
    Private Sub name_array(ByVal num_of_cols As Integer)
        ...
        Next
        ' MsgBox(num_of_cols.ToString + " num of cols")
        Dim i5 As Integer
        i5 = 2
    ...
    Private Sub csv1(ByRef append As String, ByRef cc As Integer)
        ...
        While f2 <= total1
            ...
            Try
                ...
                csv(f2) = buffer
                ' csv(f2) = csv(f2).Remove(csv(f2).IndexOf(","), 1)
                ' MsgBox(csv(f2) + " " + f2.ToString)
                f2 = f2 + 1
